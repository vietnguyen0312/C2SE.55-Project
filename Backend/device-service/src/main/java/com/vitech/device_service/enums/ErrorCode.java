...
public enum ErrorCode {
    ...
    DATE_FUTURE_OR_PRESENT(2015, "Date must be a future date or today  ", HttpStatus.BAD_REQUEST),
    DATE_PAST_OR_PRESENT(2016, "Date must be a past date or today  ", HttpStatus.BAD_REQUEST),
    ;
